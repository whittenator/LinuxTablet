...
def developCallBack():
	#subprocess.Popen("i7") 
	subprocess.Popen(['lxterminal',"--geometry=98x30+0+0",'--working-directory=/usr/local/bin'])
...
def helpCallBack():
	...
	textbox.insert(END, """Linux Tablet Help Menu
                                                1. Linux Mode:
                                                In this mode, you can explore a full Linux OS using Raspbian.
                                                2. Develop Mode:
